      ...
      <div className="container mx-auto px-3 sm:px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 px-1">
            Você está com <span className="text-red-500">dificuldade de escalar seu negócio</span> e está <span className="text-red-500">jogando dinheiro fora</span> com tráfego enquanto seu <span className="text-dark-primary">comercial não converte</span>?
          </h1>
