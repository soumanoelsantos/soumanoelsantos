      ...
      <div className="container mx-auto px-3 sm:px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 px-1">
            <span className="text-dark-primary">Rafael Medeiros</span>, você está com <span className="text-red-500">dificuldade de escalar seu negócio</span> e está <span className="text-red-500">jogando dinheiro fora</span> com tráfego enquanto seu <span className="text-dark-primary">comercial não converte</span>?
          </h1>
          ...
          <div className="mb-6">
            <LeadCaptureForm 
              ...
              buttonClassName="w-full md:w-auto bg-dark-primary hover:bg-dark-primary/90 text-black text-xs sm:text-base py-3 sm:py-4 px-2 sm:px-8 rounded-full shadow-lg transform hover:scale-105 transition-all duration-300"
