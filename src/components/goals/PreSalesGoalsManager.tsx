...
import { CreatePreSalesGoalData } from '@/types/preSalesGoals';
...
const PreSalesGoalsManager = () => {
  ...
  const { preSalesGoals, isLoading, createPreSalesGoal, deletePreSalesGoal } = usePreSalesGoals(selectedMonth, selectedYear);
