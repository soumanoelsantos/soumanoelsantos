...
export const saveDashboardConfig = async (config: DashboardConfig, userId: string): Promise<void> => {
  ...
  try {
    ...
    console.log('🔵 dashboardConfigService - Prepared data for database:', configData);
...
// Função auxiliar para mapear dados do banco para a config
const mapDatabaseToConfig = (data: any): DashboardConfig => {
  return {
